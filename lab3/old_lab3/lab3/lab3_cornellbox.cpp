...
//shadows
const unsigned int SHADOW_WIDTH = 4096, SHADOW_HEIGHT = 409;
GLuint depthMapFBO;
GLuint depthMap;
...
struct CornellBox {
	...
	void render(glm::mat4 cameraMatrix) {
        ...
        std::cout << "Light Intensity: " << lightIntensity.x << ", " << lightIntensity.y << ", " << lightIntensity.z << std::endl;
...
/*int main(void) {
    ...
    // Set the key and cursor position callbacks
    glfwSetKeyCallback(window, key_callback);
    glfwSetCursorPosCallback(window, cursor_callback);
